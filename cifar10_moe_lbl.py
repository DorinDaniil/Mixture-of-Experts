"""Эксперимент: CIFAR-10 + Mixture of Experts с Load-Balancing Loss (LBL).

Использует структуру MoELayer и load_balancing_loss из src/moe_lbl.py.
"""
...
class MoEClassifier(nn.Module):
    """Класс с MoE-слоем для классификации."""
